    ...
    switch (key.name) {
      ...
      case "]": {
        ...
        const nextSectionIndex =
          (currentSectionIndex + 1) % sectionBoundaries.length;
      ...
      case "down":
        if (state.ui.focusedPane === "sidebar") {
          ...
          const newIndex =
            state.ui.selectedFlagIndex < maxFlagIndex
        ...
        if (state.ui.focusedPane === "sidebar") {
          ...
          switch (currentFlag.type) {
            ...
            case "single-select":
              ...
              break;
            case "multi-select": {
              const filterChar = currentFlag.id.replace(
                "diffFilter",
                "",
              ) as DiffFilterType;
      ...
      case "delete":
        ...
        if (state.ui.focusedPane === "sidebar") {
          ...
          if (
            currentFlag &&
            (currentFlag.type === "text" || currentFlag.type === "number")
          ) {
        ...
        <>
          ...
          <box height={LAYOUT.mainFooter.height}>
            <text fg={THEME.text.dimmed}>
              {formatFooterHints(MAIN_FOOTER_HINTS)}
            </text>
          </box>
        </>
      ) : (
